    ...
    public static class DBWorker {
        ...
        public static User getUser(int id) {
            ...
            preparedStatement.execute();
                ...
                while(res.next())
                    user = new User(res.getInt(1), res.getString(2), res.getInt(3), res.getInt(4), res.getTime(5), res.getDate(6),res.getInt(7));
        ...
        public static ArrayList<User> getUsers(String name) {
            ...
            user = new User(res.getInt(1), res.getString(2), res.getInt(3), res.getInt(4), res.getTime(5), res.getDate(6), res.getInt(7));
                ...
                while(res.next()) {
                    ...
                    int isBestScore = res.getInt(7);

                    user = new User(id, name, placeInTopList, bestScore, bestTime, gameDate,isBestScore);
                    users.add( user );
                }
                preparedStatement.execute();
            } catch (SQLException e) {
        ...
        public static ArrayList<User> getAll() {
            ...
            try {
                ...
                while(res.next()) {
                    ...
                    Date gameDate = res.getDate(6);
                    int isBestScore = res.getInt(7);
                    curUser = new User(id, name, placeInTopList, bestScore, bestTime, gameDate, isBestScore);
                    users.add( curUser );
                }
