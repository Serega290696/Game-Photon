...
public class GameConfiguration {
    ...
    public int playersAmount = Main.defPlayersAmount;
    public int isBot=Main.defBotAmount;
...
//    public float gravitationParameter = defaultGravitationPower;
    ...
    public float gravitationParameter[] = new float[2]; ///Main.defBotAmount + Main.defPlayersAmount];
    ...
    public GameConfiguration() {
        System.out.println(Main.defPlayersAmount + Main.defBotAmount+"{{{");
        scoreBonusByPrism = 100;
        scoreBonusByObstacle = -50;
        defaultGravitationPower = 5;
        for(int i = 0; i < (playersAmount+isBot); i++) {
