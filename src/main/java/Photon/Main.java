...
public class Main {
        ...
        public static int defBotAmount = 0;
        public static int defPlayersAmount = 1;
        public static boolean defMute = false;
...
//            restartGame();
    ...
    public static void restartGame(boolean g) {
        initGame();
...
//                mouseGrabbed(false);
    ...
    public static void initDBWorker() {
        dbWorker = new ListWorker.DBWorker();
    }

        public static void initGame() {
            System.out.println("Amount players: " + (defBotAmount +  defPlayersAmount));
            game = new Game();
        }

        private static void gameLoop() {
            while (!Display.isCloseRequested()&& !stopGame) {
                getInput();
                update();
                render();
